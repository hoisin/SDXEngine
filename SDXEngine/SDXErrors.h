...
namespace SDXEngine
{
	enum class SDXErrorId
	{
		...
		// Material errors
		SDX_ERROR_MATERIALMGR_ID_ALREADY_EXIST,

		// Texture MGR
		SDX_ERROR_TEXTUREMGR_ID_ALREADY_EXIST,
		SDX_ERROR_TEXTUREMGR_FAILED_CREATE,

		// Asset MGR
		SDX_ERROR_ASSETMGR_NOT_INITIALISED,
		SDX_ERROR_ASSETMGR_DUPLICATE_MESHID,
